...
class InvoicePaymentController extends Controller
{
    ...
    public function storeForCustomer(Customer $customer, Request $request)
    {
        ...
        $data = $request->validate([
            ...
            'paid_at' => 'required_if:method,cash|nullable|date',
            ...
            'received_at' => 'required_if:method,cheque|nullable|date',
            'due_date' => 'required_if:method,cheque|nullable|date',
            'status' => 'required_if:method,cheque|nullable|in:registered,unregistered',
        ]);
