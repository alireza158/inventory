...
class PermissionCatalog
{
    ...
    public static function groups(): array
    {
        return [
            ...
            'پیش‌فاکتور و فروش' => [
                ...
                'warehouse.reservations.view' => 'مشاهده ردیابی رزروهای موجودی',
                'warehouse.reservations.release' => 'آزادسازی دستی رزرو موقت موجودی',
    ...
    public static function sidebarPages(): array
    {
        return [
            ...
            'انبارداری' => [
                ...
                ['permission' => 'warehouse.reservations.view', 'label' => 'ردیابی رزروها'],
    ...
    public static function routePermissions(): array
    {
        return [
            ...
            'vouchers.index' => 'issues.view', 'vouchers.sales.index' => 'issues.view', 'vouchers.sales.queue' => 'stock_out.view', 'vouchers.sales.queue.data' => 'stock_out.view', 'vouchers.sales.shipped' => 'stock_out.view', 'warehouse.shipping.index' => 'stock_out.view', 'warehouse.shipping.mark-shipped' => 'stock_out.confirm', 'vouchers.sales.edit' => 'issues.edit', 'vouchers.sales.show' => 'issues.view', 'vouchers.sales.history' => 'issues.view', 'vouchers.sales.update' => 'issues.edit', 'vouchers.sales.status' => 'issues.confirm', 'vouchers.sales.print' => 'issues.print', 'vouchers.section.index' => 'issues.view', 'vouchers.section.return-from-sale.export' => 'issues.view', 'vouchers.section.return-from-sale.ajax.customers' => 'issues.view', 'vouchers.section.return-from-sale.ajax.categories' => 'issues.view', 'vouchers.section.return-from-sale.ajax.subcategories' => 'issues.view', 'vouchers.section.return-from-sale.ajax.products' => 'issues.view', 'vouchers.section.return-from-sale.ajax.product-variants' => 'issues.view', 'vouchers.section.create' => 'issues.create', 'vouchers.section.store' => 'issues.create', 'vouchers.create' => 'issues.create', 'vouchers.store' => 'issues.create', 'vouchers.invoice.products' => 'issues.view', 'vouchers.sale-delivery.index' => 'stock_out.view', 'vouchers.sale-delivery.edit' => 'stock_out.edit', 'vouchers.sale-delivery.update' => 'stock_out.edit', 'vouchers.return.customer.invoices' => 'issues.view', 'vouchers.return.customer-invoices' => 'issues.view', 'vouchers.show' => 'issues.view', 'vouchers.edit' => 'issues.edit', 'vouchers.update' => 'issues.edit', 'vouchers.destroy' => 'issues.delete', 'warehouse.outputs' => 'stock_out.view', 'warehouse.reservations.index' => 'warehouse.reservations.view', 'warehouse.reservations.draft.release' => 'warehouse.reservations.release',
            'asset.hub' => 'assets.view', 'asset.personnel.index' => 'assets.documents.view', 'asset.documents.index' => 'assets.documents.view', 'asset.documents.create' => 'assets.documents.create', 'asset.documents.store' => 'assets.documents.create', 'asset.documents.show' => 'assets.documents.view', 'asset.documents.view' => 'assets.documents.view', 'asset.documents.print' => 'assets.documents.print', 'asset.documents.signed-form.view' => 'assets.documents.print', 'asset.documents.signed-form.download' => 'assets.documents.print', 'asset.documents.edit' => 'assets.documents.edit', 'asset.documents.update' => 'assets.documents.edit', 'asset.documents.finalize' => 'assets.documents.confirm', 'asset.documents.cancel' => 'assets.documents.cancel', 'asset.codes.search' => 'assets.codes.search', 'asset.codes.find' => 'assets.codes.search',
            ...
            'persons.index' => 'customers.view', 'persons.store' => 'customers.create', 'persons.update' => 'customers.edit',
