<!doctype html><html lang='fa' dir='rtl'><head><meta charset='utf-8'><title>گزارش بررسی انبار</title><style>body{font-family:Tahoma,Arial,sans-serif;font-size:12px;color:#111827}table{width:100%;border-collapse:collapse}th,td{border:1px solid #ddd;padding:6px}th{background:#f3f4f6}.no-print{display:none}@media print{.btn,.sidebar,.navbar{display:none!important}}</style></head><body>
