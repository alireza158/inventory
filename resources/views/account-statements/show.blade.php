                ...
                @forelse($ledgers as $ledger)
                    @php
                        ...
                        if ($transfer) {
                            ...
                            $transferTypeOptions = \App\Models\WarehouseTransfer::typeOptions();
                            $transferTypeLabel = isset($transferTypeOptions[$transfer->voucher_type])
                                ? $transferTypeOptions[$transfer->voucher_type]
                                : (string) $transfer->voucher_type;
