...
if ($oldDesignNotes === null) {
    ...
    $existingVariants = $product->variants->map(function ($v) {
        return [
            ...
            'variety_id' => $v->variety_id ? (int) $v->variety_id : null,
        ];
    })->values();
@endphp
    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('products.update', $product) }}" id="productEditForm" class="row g-3" enctype="multipart/form-data">
            ...
            <div class="col-12">
                <div class="card-soft">
                    <div class="section-head">
                        <div class="section-title">شناسه متغیر سایت (برای سینک API)</div>
                        <div class="muted">برای هر تنوع، شناسه همان متغیر داخل سایت را وارد کنید.</div>
                    </div>
