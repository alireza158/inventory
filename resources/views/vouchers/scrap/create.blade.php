        ...
        <form method="POST" action="{{ route('vouchers.section.store', 'scrap') }}">
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input type="hidden" name="from_warehouse_id" value="{{ (int) $centralWarehouseId }}">
                </div>
                <div class="col-md-4">
                    <label class="form-label">انبار مقصد (ضایعات)</label>
                    <select name="to_warehouse_id" class="form-select" required>
                        <option value="">انتخاب...</option>
                        @foreach($warehouses as $warehouse)
                            @if((int) $warehouse->id !== (int) $centralWarehouseId)
                ...
                <div class="col-12">
                    <table class="table" id="itemsTable"><thead><tr><th>محصول (جستجو با نام/کد)</th><th>مدل / طرح‌بندی</th><th>تنوع/طرح</th><th>موجودی تنوع</th><th>تعداد</th><th></th></tr></thead><tbody></tbody></table>
