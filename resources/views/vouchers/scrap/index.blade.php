...
<div class="container py-3">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="mb-0">حواله ضایعات</h4>
        <div class="d-flex gap-2">
            <a class="btn btn-outline-secondary" href="{{ route('vouchers.index') }}">بازگشت</a>
            <a class="btn btn-primary" href="{{ route('vouchers.section.create', 'scrap') }}">+ ثبت جدید</a>
        </div>
    </div>
    ...
    <div class="card">
        <div class="table-responsive">
            <table class="table table-striped mb-0">
                <thead><tr><th>#</th><th>شماره</th><th>تاریخ</th><th>مبدا</th><th>کاربر</th><th></th></tr></thead>
                <tbody>
                ...
                @empty
                    <tr><td colspan="6" class="text-center py-4 text-muted">موردی ثبت نشده است.</td></tr>
                @endforelse
                </tbody>
            </table>
        </div>
