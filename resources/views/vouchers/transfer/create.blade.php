    ...
    <div class="card"><div class="card-body">
        <form method="POST" action="{{ route('vouchers.section.store', 'transfer') }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-12"><table class="table" id="itemsTable"><thead><tr><th>سردسته</th><th>دسته‌بندی</th><th>کالا</th><th>تعداد</th><th></th></tr></thead><tbody></tbody></table><button type="button" class="btn btn-outline-secondary btn-sm" id="addItemBtn">+ افزودن ردیف</button></div>
