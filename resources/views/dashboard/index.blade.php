...
<div class="dashboard-shell">
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-6 col-xl-3">
            <a href="{{ route('preinvoice.draft.index') }}" class="dash-surface dash-soft p-3 h-100 text-decoration-none d-block">
                <div class="dash-kpi-accent kpi-finance"></div>
        ...
        <div class="col-md-6 col-xl-3">
            <a href="{{ route('vouchers.index') }}" class="dash-surface dash-soft p-3 h-100 text-decoration-none d-block">
                <div class="dash-kpi-accent kpi-warehouse"></div>
        ...
        <div class="col-md-6 col-xl-3">
            <a href="{{ route('products.index', ['stock_status' => 'low']) }}" class="dash-surface dash-soft p-3 h-100 text-decoration-none d-block">
                <div class="dash-kpi-accent kpi-stock"></div>
    ...
    <div class="row g-3 mb-4">
        <div class="col-xl-4">
            <div class="dash-surface p-3 h-100">
                <div class="dash-summary-head">
                    <div class="dash-section-title">خلاصه فروش</div>
                </div>
        ...
        <div class="col-xl-4">
            <div class="dash-surface p-3 h-100">
                <div class="dash-summary-head">
                    <div class="dash-section-title">خلاصه انبارداری</div>
                </div>
        ...
        <div class="col-xl-4">
            <div class="dash-surface p-3 h-100">
                <div class="dash-summary-head">
                    <div class="dash-section-title">خلاصه مالی</div>
                </div>
    ...
    <div class="dash-surface p-3 mb-4" id="monthlyReportsCard"
        ...
        <div class="row g-2 mb-3">
            <div class="col-md-4">
                <div class="rounded-3 p-2" style="background:#EEF4FF;">
                    <div class="dash-muted small">پیش‌فاکتور</div>
                    <div class="fw-bold" data-summary="preinvoices">{{ number_format($monthlyReport['summary']['preinvoices']) }}</div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="rounded-3 p-2" style="background:#EEF4FF;">
                    <div class="dash-muted small">فاکتور</div>
                    <div class="fw-bold" data-summary="invoices">{{ number_format($monthlyReport['summary']['invoices']) }}</div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="rounded-3 p-2" style="background:#EEF4FF;">
        ...
        <div class="row g-2 mt-2">
            <div class="col-md-4">
                <div class="small d-flex justify-content-between dash-muted"><span>فروش ۳۰ روز</span><strong class="text-dark">{{ number_format($rolling30Summary['sales']) }}</strong></div>
            </div>
            <div class="col-md-4">
                <div class="small d-flex justify-content-between dash-muted"><span>فاکتور ۳۰ روز</span><strong class="text-dark">{{ number_format($rolling30Summary['invoices']) }}</strong></div>
            </div>
            <div class="col-md-4">
                <div class="small d-flex justify-content-between dash-muted"><span>دریافتی ۳۰ روز</span><strong class="text-dark">{{ number_format($rolling30Summary['receipts']) }}</strong></div>
            </div>
        </div>
    </div>
